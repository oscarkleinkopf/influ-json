...
| Fecha | Hecho | Notas |
|-------|--------|-------|
| 2026-08-21 | **On-skin polish + pecas soft** | Pack `product` label/escena on-skin honesta; Packs ▾ hint; import «Marcas (pecas/lunar)» → `distinctive_marks` + aviso props |
...
| 2026-08-15 | **Corte F → main (#137)** | SQLite sessions; PIN≥6; allowlist; límites; audit auth; runbook NAS |
...
| 2026-08-12 | **UX-4 restos** photo + portfolio card + CSS | `photo-analysis.js`; `buildPortfolioCard`; vault CSS; ~144 style→`.u-*` |
...
| 2026-08-12 | **Free-path regression tests** | checklist copy≠gen; skinny→ZIP 4 packs; gen stub; walkthrough clipboard |
...
- **Comercial / SaaS deploy / billing / empaquetado Windows** — aparcado (2026-08-12); retomar cuando free path + tests estén sólidos. PR #99 (Google auth) queda abierto sin urgencia.  
- Multi-tenant / OAuth / billing obligatorio como requisito del path local  
