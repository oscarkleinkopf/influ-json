...
|---|------|-------------------|--------|
| **1** | **Paso 2 · modo «primer JSON»** — tras Crear influencer, Lock & Packs muestra ficha mínima + card Copiar JSON; Biblia / pose / UGC / panel derecho / detalles de identidad van a «Más herramientas» | En viewport 900 px el botón verde es lo único grande; `data-step2-focus=1` | ✅ `#106` |
...
| **4** | **UX-1c estricto** — ≤3 destinos «Copiar JSON» (header + pack primary + empty CTAs); resto = Copiar prompt / estructura / pack X | Inventario HTML ≤3 | ✅ esta rama |
