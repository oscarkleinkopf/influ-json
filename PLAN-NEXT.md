...
## Paso 0 — Integrar lo ya construido (humano / owner)

Antes de W11, mergear en este orden a `main` (post `filter-repo`):
...
**Criterio de hecho:** `main` con tests verdes + smoke 9/9; HANDOFF apunta a este PLAN-NEXT.
